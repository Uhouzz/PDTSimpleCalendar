...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    [PDTSimpleCalendarViewWeekdayHeader appearance].textFont = [UIFont systemFontOfSize:15];
//    [PDTSimpleCalendarViewHeader appearance].backgroundColor = [UIColor redColor];
    [PDTSimpleCalendarViewHeader appearance].textFont = [UIFont systemFontOfSize:20];
